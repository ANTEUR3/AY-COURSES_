...
function BestStudents({children}: Props) {
    return (
        <div className="w-full px-[15%] lg:pb-5">
...
export const StudentCard=({student}:{student:student})=>{
    return <div className=' pb-10 relative border-2 border-gray-600 py-3 px-3 rounded-xl lg:mb-5'>
        <Image src={student.image} alt='' className='lg:w-full lg:h-[200px]' />
        <div className='lg:w-full lg:px-[3px] flex justify-between items-center'>
            <div className='flex justify-start items-center'>
             <Image src={logo} alt=''  className='w-[50px] h-[50px] rounded-full' />
             <p className='text-gray-800'>{student.name}</p>

            </div>
            <h2 className='font-bold text-green-600 lg:text-xl'>{student.points} pts</h2>
        ...
        <div className="absolute lg:px-[8px] flex justify-between items-center pt-3 absolute bottom-3">
